...
import com.thoitietsbtybinh.sbty.utils.DiffUtilCallbackForecast
import com.thoitietsbtybinh.sbty.utils.unixTimestampToDateTimeString
...
class KlimaCastAdapter : RecyclerView.Adapter<KlimaCastAdapter.Holder>() {
    ...
    private fun bindData(holder: Holder, data: Daily?) {
        ...
        holder.itemView.apply {
            ...
            if (!(context as Activity).isFinishing) Glide.with(context)
                .load(weatherConditionIconUrl).into(iv_weather_icon)
